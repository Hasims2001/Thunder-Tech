...
export const Payment = () => {
  ...
  const handleChange = (e)=>{
   ...
   if(payment === "cod"){
    ...
    setCard(prev => {
      return { ...cod, [name]: name === "pincode" || name === "cardNumber" || name === "cvv" || name === "expMonth" || name === "expYear" ? +value : value }
  })
  ...
  const successHandler = () => {
    ...
    //   description: "Your Product is ready to shipped",
    //   status: 'success',
    //   position:'top',
    //   duration: 2000,
    //   isClosable: true,
      ...
      <div className='payment'>
        ...
        <div style={{ display: "flex", justifyContent: "space-evenly" }}>
          ...
          <div style={{ width: "30%", }} className='paymentFields'>
            <Text fontSize='5xl' fontWeight={"bolder"} textAlign={"left"} className='values pay'>Payment</Text>
            <div>
              <Text fontSize='xl' textAlign={"left"} className='values'>Accepted Card</Text>
              <div style={{ width: "30%" }} className='paymentFields'>
              ...
              <div onChange={(e) => { setPayment(e.target.value) }}
                ...
                <div>
                  <input type="radio" name='paymentOptions' value={"cod"} checked={payment === "cod"} />
              ...
              <div >
                <form action="" className='paymentForm'>
                  ...
                  {
                    payment === "cod" || payment === "" ? <div>

                      <div>
                        <label htmlFor="">Email</label>
                      </div>
                      <div>
                        <input type="text" placeholder='Enter Your Email' name='email' value={cod.email}
                      ...
                      <div>
                        <input type="text" placeholder='Enter Your Address' name='address' value={cod.address}
                        onChange={handleChange}
                        aria-required/>
                      </div>
                      ...
                      <div>
                        <input type="text" placeholder='Enter Your State' name='state' value={cod.state}
                        onChange={handleChange}
                        aria-required/>
                      </div>
                      ...
                      <div>
                        <input type="text" placeholder='Enter Your District' name='district' value={cod.district}
                        onChange={handleChange}
                        aria-required/>
                      </div>
                      ...
                      <div>
                        <input type="number" placeholder='Enter Your Pincode' name='pincode' value={cod.pincode}
                        onChange={handleChange}
                        aria-required/>
                      </div>
                      ...
                      <div>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                          ...
                          <div>
                            ...
                            <div>
                              <input type="number" placeholder='Enter Card Number' name="cardNumber" value={card.cardNumber} 
                                onChange={handleChange}
                                required/>
                            </div>
                            ...
                            <div>
                              <input type="number" placeholder='Enter Month' name = "expMonth" value={card.expMonth}
                                onChange={handleChange}
                              />
                            </div>
                            ...
                            >
                              <select id="" onChange={handleChange} name="expYear" value={card.expYear}>
                            ...
                            <div >
                              <input type="number" placeholder='Enter CVV' name='cvv' value={card.cvv}
                                onChange={handleChange}
                              />
                            </div>
                          </div>
                  ...
                  <Button colorScheme='blue' className='cvv'
          ...
          <div style={{ width: "20%" }} className='visaCard'>
            <div class="card">
              <div class="card__info">
                ...
                <div class="card__valid-thru" aria-label="Valid thru">Valid</div>
