    ...
    <DIV theme={theme}>
        <div className="categoryContainer">
          ...
          <div className="categoryImages smartPhones">
            <div>
              <img
                className="image"
                src="https://rukminim2.flixcart.com/fk-p-flap/128/128/image/0a0243119f02f7a5.png?q=100"
                alt=""
              />
              <h3>Smart Phones</h3>
            </div>
      ...
      <div className="watchComp">
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ paddingLeft: "35px", marginBottom: "10px" }}>
            <WatchComp
              image={
                "https://rukminim2.flixcart.com/image/612/612/xif0q/watch/a/k/e/-original-imagnydrewxe5qeg.jpeg?q=70"
              }
            />
          </div>
          <div>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ paddingLeft: "25px", marginBottom: "10px" }}>
            <WatchComp
              image={
                "https://rukminim2.flixcart.com/image/2000/2000/xif0q/watch/n/d/w/-original-imagrk9smhqfrndu.jpeg?q=70"
              }
            />
          </div>
          <div>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ paddingLeft: "25px", marginBottom: "10px" }}>
            <WatchComp
              image={
                "https://rukminim2.flixcart.com/image/612/612/xif0q/watch/l/6/7/-original-imagrk9sggffgvdg.jpeg?q=70"
              }
            />
          </div>
          <div>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ paddingLeft: "25px", marginBottom: "10px" }}>
            <WatchComp
              image={
                "https://rukminim2.flixcart.com/image/612/612/xif0q/watch/x/d/u/1-jxrm2119-jaxer-men-original-imagr2dwpr2upfqk.jpeg?q=70"
              }
            />
          </div>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ paddingLeft: "25px", marginBottom: "10px" }}>
            <WatchComp
              image={
                "https://rukminim2.flixcart.com/image/612/612/xif0q/watch/k/1/g/-original-imagrdzezm63ms83.jpeg?q=70"
              }
            />
          </div>
      ...
      <div className="desktopComp">
        <div>
          <Desktop
            image={
              "https://rukminim2.flixcart.com/image/312/312/l0fm07k0/television/7/x/9/-original-imagc8fnpx39evgc.jpeg?q=70"
            }
            text={"LG WebOS TV"}
            price={"13,990"}
          />
        ...
        <div>
          <Desktop
            image={
              "https://rukminim2.flixcart.com/image/312/312/l2ghgnk0/television/b/h/f/l40m7-eain-mi-original-imagdsdw9gkhscmb.jpeg?q=70"
            }
            text={"Mi 5A 100cm Smart TV"}
            price={"21,999"}
          />
        </div>
        ...
        <div>
          <Desktop
            image={
              "https://rukminim2.flixcart.com/image/312/312/l572ufk0/television/e/f/g/32y1-32y1-infinix-original-imagfxczrxjjwxvf.jpeg?q=70"
            }
            text={"Infinix Y1 80 cm (32 inch) "}
            price={"8,499"}
          />
        </div>
        ...
        <div>
          <Desktop
            image={
              "https://rukminim2.flixcart.com/image/312/312/l3uhvgw0/television/x/q/x/-original-imageuxkcg2fbdkg.jpeg?q=70"
            }
            text={"realme Android TV"}
            price={"18,999"}
          />
        </div>
      </div>
      ...
      <div className="reviews">
        <div>
          <Review
            ...
            review={
              " 800$ and beats the iPhone 14 pro max, s23 ultra, and the Pixel 7 pro in practically everything."
            }
            design={"\u2605 \u2605 \u2605 \u2605 \u2605"}
            battery={"\u2605 \u2605 \u2605 \u2605 \u2606"}
            camera={"\u2605 \u2605 \u2605 \u2605 \u2605"}
            image={
              "https://m.media-amazon.com/images/I/71jvbxyQ2TL._AC_UY327_FMwebp_QL65_.jpg"
            }
            value={""}
            display={"\u2605 \u2605 \u2606 \u2606 \u2606"}
          />
        ...
        <div>
          <Review
            ...
            review={
              "Use an Iphone for a month before planning to buy it over Android.Good product value of money"
            }
            design={"\u2605 \u2605 \u2606 \u2606 \u2606"}
            battery={"\u2605 \u2605 \u2605 \u2605 \u2606"}
            camera={"\u2605 \u2605 \u2605 \u2605 \u2605"}
            image={
              "https://rukminim2.flixcart.com/image/312/312/xif0q/mobile/l/8/r/-original-imaghxemnnnkd8bg.jpeg?q=70"
            }
            value={""}
            display={"\u2605 \u2605 \u2606 \u2606 \u2606"}
          />
        ...
        <div>
          <Review
            ...
            review={
              "good camera quality preformance is also good , battery backup is quite not good but good value of money"
            }
            design={"\u2605 \u2606 \u2606 \u2606 \u2606"}
            battery={"\u2605 \u2605 \u2605 \u2605 \u2606"}
            camera={"\u2605 \u2605 \u2605 \u2605 \u2605"}
            image={
              "https://rukminim2.flixcart.com/image/312/312/xif0q/mobile/b/f/m/-original-imagna3ezkdusyrz.jpeg?q=70"
            }
            value={""}
            display={"\u2605 \u2605 \u2606 \u2606 \u2606"}
          />
